        ...
        <div className={styles.container}>
            ...
            <BrandingForm
                initial={{
                    ...
                    colorSidebarHoverBg: currentTenant.colorSidebarHoverBg || '',
                    colorSidebarHoverText: currentTenant.colorSidebarHoverText || '',
                    colorTopbarBg: currentTenant.colorTopbarBg || '',
                    colorTopbarText: currentTenant.colorTopbarText || '',
